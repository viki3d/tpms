        ...
        public void open(UsbDeviceConnection connection) throws IOException {
            ...
            if (this.mDevice.getDeviceClass() == 2) {
                ...
                try {
                    ...
                    Log.e(ProlificSerialDriver.this.TAG, "An unexpected exception occured while trying to detect PL2303 subtype");
                }
            }
                ...
                synchronized (this.mReadStatusThreadLock) {
                    if (this.mReadStatusThread != null) {
                        try {
                            ...
                            Log.w(ProlificSerialDriver.this.TAG, "An error occured while waiting for status read thread");
                        }
                    }
                }
                resetDevice();
